...
def run():
    inicio = time.time()
    i = 163 #Parametro inical matéria
    limit = 0
    ...
    while limit < 9:     
        ...
        mouse_click(145, i) #canal click
        mouse_click(139, p) #geral click
        time.sleep(2)
        mouse_click(avaliacoes_cordx, avaliacoes_cordy) #avaliações click
        time.sleep(6)
